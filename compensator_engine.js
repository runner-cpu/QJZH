/**
 * Run the browser-side highland ammonia compensation model.
 ...
 * @param {number} raw_ppm Uncompensated NH3 reading in ppm, calibrated for 0-30 ppm.
 * @returns {number} Compensated NH3 concentration in ppm.
 * @throws {Error} When model_weights.js has not been loaded.
 */
(function (root) {
  "use strict";
